...
import { EmbedBuilder, ActionRowBuilder, StringSelectMenuBuilder, StringSelectMenuOptionBuilder, PermissionsBitField } from "discord.js";
...
async function handleEmojiButtons(interaction) {
...
async function handleEmojiCategorySelect(interaction) {
    ...
    const embed = new EmbedBuilder()
        ...
        .setDescription(`> **Emojis disponíveis nesta categoria:**\n\n` +
...
async function handleTextSelect(interaction) {
    ...
    const embed = new EmbedBuilder()
        ...
        .setDescription(`> **Personalização de textos para ${panelNames[panel]}:**\n\n` +
        `📝 **Título do painel**\n` +
        `📄 **Descrição principal**\n` +
        `🔗 **Textos dos botões**\n` +
        `📋 **Textos informativos**\n\n` +
...
async function handleResetButtons(interaction) {
    ...
    if (action === "confirm") {
        ...
        if (emojiSuccess) {
            const embed = new EmbedBuilder()
                ...
                .setDescription(`✅ **Todas as configurações foram resetadas!**\n\n` +
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(`🔒 **Operação cancelada pelo usuário**\n\n` +
