...
const guildLogChannels = new Map<string, string>();

function setGuildLogChannel(guildId: string, channelId: string): void {
...
(globalThis as any).eixoLogConfig = { setGuildLogChannel, getLogChannel };
    ...
    async run(interaction) {
        ...
        try {
            ...
            const testEmbed = new EmbedBuilder()
                ...
                .setDescription(
                    `**Canal de logs configurado:** ${logChannel}\n\n` +
            ...
            const successEmbed = new EmbedBuilder()
                ...
                .setDescription(
                    `O canal ${logChannel} foi configurado como canal de logs!\n\n` +
    ...
    async run(interaction) {
        ...
        try {
            ...
            const testEmbed = new EmbedBuilder()
                ...
                .setDescription(
                    `**Teste executado por:** ${interaction.user.tag} \`(${interaction.user.id})\`\n` +
