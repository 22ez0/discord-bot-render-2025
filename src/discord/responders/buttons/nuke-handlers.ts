...
import { EmbedBuilder, ButtonInteraction, ChannelType, PermissionsBitField } from "discord.js";
...
async function handleNukeCancel(interaction: ButtonInteraction) {
...
async function handleNukeConfirm(interaction: ButtonInteraction, channelId: string) {
    await interaction.deferUpdate();
