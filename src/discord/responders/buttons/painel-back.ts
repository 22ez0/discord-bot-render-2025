...
import { EmbedBuilder, ActionRowBuilder, StringSelectMenuBuilder, StringSelectMenuOptionBuilder, ButtonInteraction } from "discord.js";
...
createResponder({
    ...
    async run(interaction: ButtonInteraction) {
        ...
        const mainEmbed = new EmbedBuilder()
            ...
            .setDescription(
                `**Bem-vindo ao sistema de administração completo!**\n\n` +
