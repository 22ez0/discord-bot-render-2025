...
async function handleModerationPanel(interaction: ButtonInteraction) {
...
async function handleAutomationPanel(interaction: ButtonInteraction) {
    await interaction.update({
        embeds: [new EmbedBuilder()
            .setColor("#2ed573")
...
async function handleFunPanel(interaction: ButtonInteraction) {
    await interaction.update({
        embeds: [new EmbedBuilder()
            .setColor("#ff6b81")
            .setTitle("<a:A_Tada:1418647260002254981> **DIVERSÃO** | Entretenimento")
            .setDescription(
                `> **Comandos de diversão disponíveis:**\n\n` +
...
async function handleUtilsPanel(interaction: ButtonInteraction) {
    await interaction.update({
        embeds: [new EmbedBuilder()
            .setColor("#ffa502")
            .setTitle("<:serverowner:1418752887768481792> **UTILIDADES** | Ferramentas Úteis")
            .setDescription(
                `> **Comandos de utilidade disponíveis:**\n\n` +
